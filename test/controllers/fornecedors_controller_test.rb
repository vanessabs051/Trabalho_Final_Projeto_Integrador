...
class FornecedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fornecedor" do
    assert_difference('Fornecedor.count') do
      post fornecedors_url, params: { fornecedor: { cep: @fornecedor.cep, cnpj_cpf: @fornecedor.cnpj_cpf, email: @fornecedor.email, logradouro: @fornecedor.logradouro, nome: @fornecedor.nome, telefone: @fornecedor.telefone } }
    end
  ...
  test "should update fornecedor" do
    patch fornecedor_url(@fornecedor), params: { fornecedor: { cep: @fornecedor.cep, cnpj_cpf: @fornecedor.cnpj_cpf, email: @fornecedor.email, logradouro: @fornecedor.logradouro, nome: @fornecedor.nome, telefone: @fornecedor.telefone } }
