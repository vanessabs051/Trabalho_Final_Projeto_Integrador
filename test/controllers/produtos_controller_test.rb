...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { fornecedor_id: @produto.fornecedor_id, marca: @produto.marca, nome: @produto.nome, preco: @produto.preco, quantidade: @produto.quantidade, validade: @produto.validade } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { fornecedor_id: @produto.fornecedor_id, marca: @produto.marca, nome: @produto.nome, preco: @produto.preco, quantidade: @produto.quantidade, validade: @produto.validade } }
